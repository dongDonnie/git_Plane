...
cc.Class({
    ...
    onActiveRewardBoxClick: function (event, active) {
        ...
        if (platformApi && GlobalVar.me().vipLevel < 3 && GlobalVar.canShowVideo(true)) {
        ...
        } else if (platformApi && GlobalVar.me().vipLevel < 3 && !GlobalVar.canShowVideo(true)) {
    ...
    onNewTaskBtnRecvClick: function (event, customEventData) {
        ...
        if (customEventData == 0) {
            ...
            if (platformApi && GlobalVar.canShowVideo(true)) {
            ...
            } else if (platformApi && !GlobalVar.canShowVideo(true)){
