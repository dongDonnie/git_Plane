...
cc.Class({
    ...
    enter: function (isRefresh) {
        ...
        let platformApi = GlobalVar.getPlatformApi();
        if (platformApi){
            this.getNodeByName('btnRecv').getChildByName("spriteVideo").active = GlobalVar.canShowVideo();
            this.getNodeByName('btnRecv').getChildByName("spriteShare").active = !GlobalVar.canShowVideo();
        }
