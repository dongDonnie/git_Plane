...
var UIMain = cc.Class({
    ...
    onLoad: function () {
        ...
        if (GlobalVar.isWechatPlat) {
            if (GlobalVar.firstTimeLaunch) {
                ...
                platformApi.setWithShareTicket(true);
                platformApi.getMaterials(function (data) {
                    ...
                    wx.onShareAppMessage(res => {
                        ...
                        platformApi.reportShareMaterial(101);
                ...
                platformApi.createRewardedVideoAd();
                platformApi.createBannerAdList();
            }

            if (GlobalVar.me().roleID == GlobalVar.me().roleName) {
                platformApi.getUserInfo(function (userInfo) {
    ...
    showLaunchWindow: function () {
        ...
        if (GlobalVar.isWechatPlat && GlobalVar.getShareSwitch() && GlobalVar.getShareControl() == 1 && StoreageData.getShareTimesWithKey("firstTimeLaunchGame", 0) && GlobalVar.me().shareData.getInviteGiftBagState() < (GlobalVar.tblApi.getLength("TblFuliInvite")) && GlobalVar.firstTimeLaunch) {
        ...
        // 请求公众号奖励
        if (GlobalVar.isFromOfficialAccount && GlobalVar.isWechatPlat) {
    ...
    showDeskIcon: function () {
        this.getNodeByName('btnoAdExp').active = !config.NEED_GUIDE && (GlobalVar.isWechatPlat || GlobalVar.isDebug);
        this.getNodeByName('AdFrame').active = !config.NEED_GUIDE && (GlobalVar.isWechatPlat || GlobalVar.isDebug);
        this.getNodeByName('btnoAdTask').active = !config.NEED_GUIDE && (GlobalVar.isWechatPlat || GlobalVar.isDebug);
        ...
        this.getNodeByName('btnoFuli').active = GlobalVar.getShareSwitch() && (GlobalVar.isWechatPlat || GlobalVar.isDebug);
        ...
        this.getNodeByName('btnoAdTask').active = level >= openLevel && (GlobalVar.isWechatPlat || GlobalVar.isDebug);
        ...
        let btnoSuperGift = this.getNodeByName("btnoSuperGift");
        if (!GlobalVar.me().shareData.getSuperRewardState() && (GlobalVar.isWechatPlat || GlobalVar.isDebug)) {
        ...
        if (GlobalVar.me().fuLiGCBag.OfficialAccountDraingetFlag == 0 && GlobalVar.me().getLevel() >= 4
            && platformApi.shareSetting.vpnaFlag == 1 && GlobalVar.getShareSwitch() && (GlobalVar.isWechatPlat || GlobalVar.isDebug)) {
        ...
        if (GlobalVar.isAndroid && GlobalVar.me().getLevel() >= 4 && platformApi.shareSetting.heziFlag == 1 && GlobalVar.getShareSwitch() && (GlobalVar.isWechatPlat || GlobalVar.isDebug)) {
            btnBoxReward && (btnBoxReward.active = true) && (GlobalVar.isWechatPlat || GlobalVar.isDebug);
        }
        else {
        ...
        if (GlobalVar.me().fuLiGCBag.HeZiReward == 0 && (GlobalVar.isWechatPlat || GlobalVar.isDebug)) {
        ...
        if (GlobalVar.getShareSwitch() && GlobalVar.me().shareData.getInviteGiftBagState() < (GlobalVar.tblApi.getLength("TblFuliInvite")) && (GlobalVar.isWechatPlat || GlobalVar.isDebug)) {
