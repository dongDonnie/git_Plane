...
var arenaData = cc.Class({
    ...
    setArenaRankTopListData: function (data) {
        if (data.ErrCode == GameServerProto.PTERR_SUCCESS) {
            ...
            self.data.likeClicks = data.OK.LikeClicks;
    ...
    setArenaChallengeData: function (data) {
        if (data.ErrCode == GameServerProto.PTERR_SUCCESS) {
            self.data.FreeChallengeCount = data.OK.FreeChallengeCount;
            self.data.ChallengeCount = data.OK.ChallengeCount;
            self.arenaOpenData.ChallengeLimit = data.OK.ChallengeLimit;
            self.data.Points = data.OK.Points;
    ...
    setArenaPointChangeData: function (data) {
        if (data.ErrCode == GameServerProto.PTERR_SUCCESS) {
            self.data.Points = data.OK.PointsCur;
        }
    ...
    setArenaChallengeCountFreeGetData: function (data) {
        if (data.ErrCode == GameServerProto.PTERR_SUCCESS) {
            self.data.FreeGetCount = data.FreeGetCount;
        }
    ...
    setArenaPointChangeData: function (data) {
        self.data.Points = data.PointsCur;
        GlobalVar.eventManager().dispatchEvent(EventMsgID.EVENT_GET_ARENA_POINT_CHANGE_DATA, data);
    },
    setOldArenaList: function (list) {
        self.oldArenaList = list;
    },

    getOldArenaList: function () {
        if (!!self.oldArenaList) {
            return self.oldArenaList;
        }
        return null;
    },
    ...
    getChallengeCount: function () {
        if (self.data) {
            return self.data.ChallengeCount;
        }
    },
    ...
    getFreeChallengeCount: function () {
        if (self.data) {
            return self.data.FreeChallengeCount;
        }
    },
