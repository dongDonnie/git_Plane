...
CampNormal215.data = {
    ...
    monsterWaves:[
        ...
        {wave:{groups:[869,44,45],wait:0,delay:[0,1.5,2]}}, {wave:{groups:[1393,562,554],wait:0,delay:[0,0,2]}},
      
        {wave:{groups:[1392,996],wait:0,delay:[0,0]}},  {wave:{groups:[870,842],wait:0,delay:[0,0]}},
